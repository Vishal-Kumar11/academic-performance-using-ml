...
class AcademicPerformancePredictor:
    ...
    def predict(self, features: pd.DataFrame) -> List[float]:
        ...
        try:
            import os
            model_path = os.path.join(os.getcwd(), 'artifacts', 'academic_performance_model.pkl')
            preprocessor_path = os.path.join(os.getcwd(), 'artifacts', 'academic_preprocessor.pkl')
